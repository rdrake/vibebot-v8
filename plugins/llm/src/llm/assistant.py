...
VERSE_SYSTEM_PROMPT = (
    ...
    "verse_record HARD RULE: whenever ANY named character that isn't "
    "your own avatar acts, speaks, arrives, leaves, or does something "
    "in-world, call verse_record alongside your reply. Applies in BOTH "
    "directions — events the user describes AND events you are about "
    "to narrate. Write the in-character scene AS your reply, AND call "
