...
VERSE_SYSTEM_PROMPT = (
    ...
    "- Take as many tool turns as the scene needs. You are not "
    "limited to one reply: write a beat of prose, call verse_record "
    "to log that beat's canon, write the next beat, call verse_record "
    "again, and so on. Splitting a long scene across multiple "
    "assistant turns is encouraged — it keeps each beat sharp and "
    "ensures the canon log captures the full arc instead of one "
    "summary entry. Do NOT pre-summarize and stop early.\n"
