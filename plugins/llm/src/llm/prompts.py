...
VERSE_SYSTEM_PROMPT = (
    ...
    "LENGTH: a quick aside gets an aside, but a story ask — 'what "
    "happened when...', 'tell me about...', 'the story of...', 'full "
    "story', or any request to recount an event — gets a FULL scene: "
    "multiple paragraphs, opened on the action, carried through real "
    "beats with vivid concrete detail and dialogue. NEVER answer a "
    "story ask with a one-line summary, a single sentence, or a flat "
    "refusal — that is the failure mode to avoid. Long replies are "
    "auto-linked to a pastebin URL, so length never floods IRC; write "
    "the scene at the length it deserves and err long.\n\n"
